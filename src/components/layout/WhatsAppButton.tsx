...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-lg transition-all duration-200 hover:scale-110 hover:bg-green-600 hover:shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 md:h-16 md:w-16"
    ...
    >
      ...
      {/* Pulse animation */}
      <span className="absolute -inset-1 animate-ping rounded-full bg-green-400 opacity-20" />
    </a>
  );
}
